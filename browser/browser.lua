...
local EntryRepository = require("browser/repositories/entry_repository")
local FeedRepository = require("browser/repositories/feed_repository")
local CategoryRepository = require("browser/repositories/category_repository")
